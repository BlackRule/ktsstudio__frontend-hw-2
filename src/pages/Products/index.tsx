...
const Products = () => {
    ...
    const searchFilteredListLength = toJS(productsStore.searchFilteredList).length
            ...
            <div className={styles.Products}>
                ...
                <div className={styles['top-bar']}>
                    <SearchBar className={styles.SearchBar} handleSearch={
                        (v) => navigate(getNewURL("q", v, params))
                    }/>
                ...
                <div className={styles['total-product']}>
                    ...
                    <span className={styles['total-product__count']}>{searchFilteredListLength}</span>
                </div>
                {productsStoreState === State.loading ? <Loader/> :
                ...
                <PageNumbers paramName={'p'} totalPages={totalPages}
                             currentPage={currentPage} curParams={params}/>
            </div>
        </PagePadding>
    )
};
